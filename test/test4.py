...
def get_best_decryption(ciphertext, reference_bigram_frequencies,
                        iterations=100000):
...
# Get the best decryption using the Hill Climbing algorithm
best_decryption = get_best_decryption(cryptogram, reference_bigram_frequencies)
